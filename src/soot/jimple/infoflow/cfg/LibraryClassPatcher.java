...
public class LibraryClassPatcher {
	...
	/**
	 * return the ApplicationHolder class (created if needed) This is a class
	 * with 1 static field to save the application instance in
	 */
	 ...
	 * 
	 * @param smRun
	 *            The run() method for which to create a synthetic
	 *            implementation
	 * @param runnable
	 ...
	 * 
	 * @param smCons
	 *            The <init>() method for which to create a synthetic
	 *            implementation
	 * @param runnable
	 *            The "java.lang.Runnable" interface
	 * @param fldTarget
	...
	private Body patchHandlerDispatchBody(SootMethod method) {
		...
		b.getUnits()
				.add(Jimple.v().newInvokeStmt(Jimple.v()
						.newVirtualInvokeExpr(thisLocal, Scene.v().makeMethodRef(sc, "handleMessage",
	...
	private void patchServiceConnection() {
		...
		b.getUnits()
				.add(Jimple.v().newInvokeStmt(Jimple.v()
						.newInterfaceInvokeExpr(thisLocal, Scene.v().makeMethodRef(sc, "onServiceConnected",
